...
from apps.fileupload.views import BasicVersionCreateView, BasicPlusVersionCreateView, PictureCreateView, AngularVersionCreateView, jQueryVersionCreateView, PictureDeleteView
...
urlpatterns = patterns('',
    ...
    url(r'^view/$', 'apps.fileupload.views.PictureListView', name='upload-view'),
)
